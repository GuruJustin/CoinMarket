    ...
    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
        <thead>
            <tr class="nk-tb-item nk-tb-head">
                ...
                <th class="nk-tb-col tb-col-lg"><span class="sub-text">TRX ID</span></th>
                <th class="nk-tb-col tb-col-md"><span class="sub-text">GateWay</span></th>
            ...
            <tr class="nk-tb-item">
                <td class="nk-tb-col">
                    <div class="user-card">
                        ...
                        @endif
                        <div class="user-info">
                            <a href="{{route('user.single',$data->user->id)}}"><span class="tb-lead">{{$data->user->username}}<span class="dot dot-success d-md-none ml-1"></span></span></a>
                ...
                <td class="nk-tb-col tb-col-mb">
                     <span class="tb-lead">{!! $data->gateway->name !!}</span>
                </td>
                ...
                <td class="nk-tb-col nk-tb-col-tools">
                    <ul class="nk-tb-actions gx-1">
                        <li class="nk-tb-action-hidden">
                            <a href="{{route('deposit.view',$data->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="View Details">
                            ...
                            <div class="drodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="link-list-opt no-bdr">
                                        <li><a href="{{route('deposit.view',$data->id)}}"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
